...
namespace DatabaseFirst
{
    ...
    public partial class AdventureWorksContext : DbContext
    {
        ...
        [DbFunction("AdventureWorksConnectionString", "ufnGetAllCategories")]
        public virtual IQueryable<ufnGetAllCategories_Result> ufnGetAllCategories()
        {
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetAllCategories_Result>("[AdventureWorksConnectionString].[ufnGetAllCategories]()");
        }
    
        [DbFunction("AdventureWorksConnectionString", "ufnGetCustomerInformation")]
        public virtual IQueryable<ufnGetCustomerInformation_Result> ufnGetCustomerInformation(Nullable<int> customerID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ufnGetCustomerInformation_Result>("[AdventureWorksConnectionString].[ufnGetCustomerInformation](@CustomerID)", customerIDParameter);
        }
